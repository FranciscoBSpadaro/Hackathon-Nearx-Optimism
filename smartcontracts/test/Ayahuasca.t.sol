...
contract AyahuascaTest is Test {
    ...
    function testSafeMint() public {
        ...
        uint256 tokenId = instance.safeMint{value: instance.getCommonPrice()}(
            vm.addr(2), "QmY7Yh4UquoXHLPFo2XbhXkhBvFoPwmQUSa92pxnxjQuPU", Ayahuasca.NftType.COMMON
        );
        assertEq(instance.ownerOf(tokenId), vm.addr(2));
        assertEq(instance.tokenURI(tokenId), "https://ipfs.io/ipfs/QmY7Yh4UquoXHLPFo2XbhXkhBvFoPwmQUSa92pxnxjQuPU");
    }
}
