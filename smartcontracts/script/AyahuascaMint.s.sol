...
contract AyahuascaMintScript is Script {
    ...
    function run(address userAddress) public {
        ...
        ayahuasca.safeMint{value: ayahuasca.getCommonPrice()}(
            userAddress, "QmY7Yh4UquoXHLPFo2XbhXkhBvFoPwmQUSa92pxnxjQuP1", Ayahuasca.NftType.COMMON
        ); // economia de gas
        ayahuasca.safeMint{value: ayahuasca.getRarePrice()}(
            userAddress, "QmY7Yh4UquoXHLPFo2XbhXkhBvFoPwmQUSa93pxnxjQuP2", Ayahuasca.NftType.RARE
        );
        ayahuasca.safeMint{value: ayahuasca.getEpicPrice()}(
            userAddress, "QmY7Yh4UquoXHLPFo2XbhXkhBvFoPwmQUSa94pxnxjQuP3", Ayahuasca.NftType.EPIC
        );
