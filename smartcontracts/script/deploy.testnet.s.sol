...
contract OptimismTestNet is Script {
    ...
    function run(address initialOwner) public {
        ...
        console.log("ContractDeployed", address(instance));
    }
}
// sig run adress com endereço da carteira.
// forge script script/deploy.testnet.s.sol:OptimismTestNet --private-key $OPTIMISM_TESTNET_PRIVATE_KEY --rpc-url $OPTIMISM_TESTNET_RPC_URL --broadcast --sig "run(address)" 0xe...endereço da carteira e não private key

// forge script script/deploy.testnet.s.sol:OptimismTestNet --rpc-url https://sepolia.optimism.io --private-key <your_private_key>
// OU ?
// forge script script/deploy.testnet.s.sol:OptimismTestNet --rpc-url https://goerli.optimism.io --private-key <your_private_key>
